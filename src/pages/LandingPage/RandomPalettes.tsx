    ...
    >
      ...
      >
        ...
        <p className="text-black max-w-3xl mx-auto mb-12">
          Zainspiruj się gotowymi zestawieniami, które pasują do każdego
          projektu! Niezależnie od tego, czy tworzysz stronę internetową,
          aranżujesz wnętrze, czy projektujesz logo - znajdziesz tu paletę,
          która idealnie wpisuje się w Twoje potrzeby.
        </p>
      </motion.div>
