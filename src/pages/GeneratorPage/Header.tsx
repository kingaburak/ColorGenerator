  ...
  return (
    <div className="flex flex-col min-h-[80vh] items-center">
      <div className="bg-[#FFF6F7] border-4 border-beige p-8 rounded-xl mt-24">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row pl-4 gap-14">
          <div className="flex-1 flex flex-col items-center md:items-start justify-center gap-4">
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
              ...
              <div className="flex items-center md:pl-0 pl-2 gap-6 text-4xl font-bold text-[#EAA6A6]">
                <motion.button
                  onClick={handleDecrease}
                  whileTap={{ scale: 0.95 }}
                  whileHover={{ scale: 1.01 }}
                  transition={{ type: "spring", stiffness: 300, damping: 10 }}
                  className="text-3xl px-4 rounded bg-pink2 text-white hover:bg-orange hover:text-darkpink transition-colors shadow-md"
                >
                  -
                </motion.button>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.01 }}
              transition={{ type: "spring", stiffness: 300, damping: 10 }}
              className="bg-pink2 text-white px-36 md:px-44 py-3 text-sm md:text-lg font-semibold rounded-2xl hover:bg-orange hover:text-darkpink transition-colors shadow-md"
            >
              Generuj
            </motion.button>
          </div>
          ...
          <div className="flex justify-center md:flex-1">
            <img src={catPainting} className="w-48 md:w-64 h-auto mt-0" />
          </div>
        </div>
      </div>
